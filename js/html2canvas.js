...
// http://dev.w3.org/csswg/css-color/
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            var SMALL_IMAGE = exports.SMALL_IMAGE = 'data:images/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7';
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            var getImage = function getImage(node, resourceLoader) {
                if (node instanceof node.ownerDocument.defaultView.SVGSVGElement || node instanceof SVGSVGElement) {
                    ...
                    return resourceLoader.loadImage('data:images/svg+xml,' + encodeURIComponent(s.serializeToString(node)));
                }
                switch (node.tagName) {
                    case 'IMG':
                        // $FlowFixMe
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            var parseListStyle = exports.parseListStyle = function parseListStyle(style) {
                var listStyleImage = (0, _background.parseBackgroundImage)(style.getPropertyValue('list-style-images'));
                return {
...
// iOS 10.3 taints canvas with base64 images unless crossOrigin = 'anonymous'
            var testBase64 = function testBase64(document, src) {
                ...
                return new Promise(function (resolve) {
                    // Single pixel base64 images renders fine on iOS 10.3???
                    img.src = src;
...
// Other Characters
        ...
        /***/ (function(module, exports, __webpack_require__) {
                            ...
                            Promise.all((0, _background.parseBackgroundImage)(style.backgroundImage).map(function (backgroundImage) {
                                if (backgroundImage.method === 'url') {
                                    return _this.resourceLoader.inlineImage(backgroundImage.args[0]).then(function (img) {
                                        ...
                                        if (true) {
                                            _this.logger.log('Unable to load images', e);
                                        }
                                    });
                                }
             ...
             */
                    ...
                    documentClone.open();
                    documentClone.write(serializeDoctype(document.doctype) + '<images></images>');
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            var ResourceLoader = function () {
                ...
                _createClass(ResourceLoader, [{
                    ...
                    value: function xhrImage(src) {
                        ...
                        this.cache[src] = new Promise(function (resolve, reject) {
                            ...
                            xhr.onreadystatechange = function () {
                                if (xhr.readyState === 4) {
                                    if (xhr.status !== 200) {
                                        reject('Failed to fetch images ' + src.substring(0, 256) + ' with status code ' + xhr.status);
                                    } else {
                                        var reader = new FileReader();
                                        reader.addEventListener('load', function () {
                                            // $FlowFixMe
                    ...
                    value: function addImage(key, src, useCORS) {
                        ...
                        if (true) {
                            this.logger.log('Added images ' + key.substring(0, 256));
                        }
                    ...
                    value: function ready() {
                        ...
                        var values = keys.map(function (str) {
                            return _this5.cache[str].catch(function (e) {
                                if (true) {
                                    _this5.logger.log('Unable to load images', e);
                                }
                                return null;
                            });
                        });
            ...
            var _loadImage = function _loadImage(src, timeout) {
                return new Promise(function (resolve, reject) {
                    ...
                    if (timeout) {
                        setTimeout(function () {
                            return reject( true ? 'Timed out (' + timeout + 'ms) loading images' : '');
                        }, timeout);
                    }
                });
            };
